function [fN_Toeplitz] = store_Toep(ko,L,M,N,tol_Tucker)
...
fN_Toeplitz=cell(4,1);
fact_mat1=cell(7,1);fact_mat2=cell(7,1);fact_mat3=cell(7,1);core_tens=cell(7,1);
for ii=1:7
[fact_mat1{ii},fact_mat2{ii},fact_mat3{ii},core_tens{ii},~] = Tucker(G{ii},tol_Tucker);
end
fN_Toeplitz{1,1}=fact_mat1;
fN_Toeplitz{2,1}=fact_mat2;
fN_Toeplitz{3,1}=fact_mat3;
fN_Toeplitz{4,1}=core_tens;
disp(['  Time for prestore far interactions ::: ',num2str(toc)])