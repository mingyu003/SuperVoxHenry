...
p4  = genpath([currentfolder, filesep, 'AGMG_3.3.5-aca']);
...
p12 = genpath([currentfolder, filesep, 'prestored_Toeplitz']);
p13 = genpath([currentfolder, filesep, 'SVD_Tuck']);

addpath([p2, psep, p3, psep, p4, psep, p5, psep, p6, psep, p7, psep, p8, psep, p9, psep, p10, psep, p11, psep, p12 psep, p13]);
