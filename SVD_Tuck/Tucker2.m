function [factor_matrix1,factor_matrix2,factor_matrix3,core_tensor,mem] = Tucker2(tensor2comp,tolerance)
...
T3 = reshape(permute(tensor2comp,[3,1,2]),num_y,[]);
...
factor_matrix1=fft(factor_matrix1);factor_matrix2=fft(factor_matrix2);factor_matrix3=fft(factor_matrix3);
